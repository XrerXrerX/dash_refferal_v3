...
<div class="sec_table">
    ...
    <div class="group_button_ns">
        ...
        <div class="ns_right">
            <a href="#" id="deleteall-tabelnewmember">
            ...
            <a href="#" id="update-tabelnewmember">
                <div class="sec_edit">
            ...
            <a href="#" id="delete-tabelnewmember">
                <div class="sec_delete">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#update-tabelnewmember').off('click').click(function(event) {
            ...
            $('.aplay_code').load('/xx88/tabelnewmember/edit/' + parameterString, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/xx88/tabelnewmember/edit/' +
                    parameterString);
            });
        });


        $(document).off('click', '#add-tabelnewmember').on('click', '#add-tabelnewmember', function(event) {
            event.preventDefault();
            $('.aplay_code').load('/xx88/tabelnewmember/add', function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/xx88/tabelnewmember/add');
            });
        });
        // $(document).on('click', '#delete', function(event) {
        //     event.preventDefault();
        //     $('.aplay_code').load('/xx88/tabelnewmember/delete', function() {
        //         adjustElementSize();
        //         localStorage.setItem('lastPage', '/xx88/tabelnewmember/delete');
        //     });
        // })



        $(document).on('click', '#delete-tabelnewmember', function(event) {
            event.preventDefault();
            ...
            var url =
                "/xx88/tabelnewmember/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
        ...
        $(document).on('click', '#deleteall-tabelnewmember', function(event) {
            event.preventDefault();

            var url =
                "/xx88/tabelnewmember/deleteall/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
        ...
        $(document).off('click', '#view').on('click', '#view', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/xx88/tabelnewmember/view/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/xx88/tabelnewmember/view/' + id);
            });
        });
        ...
        $(document).off('click', '#edit').on('click', '#edit', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/xx88/tabelnewmember/edit/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/xx88/tabelnewmember/edit/' + id);
            });
        });
