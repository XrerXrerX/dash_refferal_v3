        ...
        <tbody>
            ...
            @foreach ($data as $index => $d)
                <tr>
                    ...
                    <td><span class="name">{{ $d->tanggal }}</span></td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#update-tabelnewmember').off('click').click(function(event) {
            ...
            $('.aplay_code').load('/tabelnewmember/edit/' + parameterString, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/tabelnewmember/edit/' +
                    parameterString);
            });
        });
        ...
        $(document).off('click', '#add-tabelnewmember').on('click', '#add-tabelnewmember', function(event) {
            event.preventDefault();
            $('.aplay_code').load('/tabelnewmember/add', function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/tabelnewmember/add');
            });
        });
        // $(document).on('click', '#delete', function(event) {
        //     event.preventDefault();
        //     $('.aplay_code').load('/tabelnewmember/delete', function() {
        //         adjustElementSize();
        //         localStorage.setItem('lastPage', '/tabelnewmember/delete');
        //     });
        // })
        ...
        $(document).on('click', '#delete-tabelnewmember', function(event) {
            ...
            var url =
                "/tabelnewmember/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
        ...
        $(document).off('click', '#view').on('click', '#view', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/tabelnewmember/view/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/tabelnewmember/view/' + id);
            });
        });
        ...
        $(document).off('click', '#edit').on('click', '#edit', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/tabelnewmember/edit/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/tabelnewmember/edit/' + id);
            });
        });
