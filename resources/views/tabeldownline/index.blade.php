...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#update-tabeldownline').off('click').click(function(event) {
            ...
            $('.aplay_code').load('/tabeldownline/edit/' + parameterString, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/tabeldownline/edit/' +
                    parameterString);
            });
        });
        ...
        $(document).off('click', '#add-tabeldownline').on('click', '#add-tabeldownline', function(event) {
            event.preventDefault();
            $('.aplay_code').load('/tabeldownline/add', function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/tabeldownline/add');
            });
        });
        ...
        $(document).off('click', '#edit').on('click', '#edit', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/tabeldownline/edit/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/tabeldownline/edit/' + id);
            });
        });
