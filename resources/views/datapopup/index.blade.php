...
<div class="sec_table">
    ...
    <a href="#" id="update-datapopup">
        <div class="sec_edit">
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-pencil" viewBox="0 0 24 24" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="show_img_tbl">
                    ...
                    <img class="table_img" src="{{ asset($d->gambar_event) }}" alt="" style="display: none;">
                </td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#update-datapopup').off('click').click(function(event) {
        ...
        $(document).on('click', '#delete-datapopup', function(event) {
            event.preventDefault();
