...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#update-allowedip').off('click').click(function(event) {
            ...
            $('.aplay_code').load('/xx88/allowedip/edit/' + parameterString, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/xx88/allowedip/edit/' +
                    parameterString);
            });
        });
        ...
        $(document).off('click', '#add-allowedip').on('click', '#add-allowedip', function(event) {
            event.preventDefault();
            $('.aplay_code').load('/xx88/allowedip/add', function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/xx88/allowedip/add');
            });
        });
        // $(document).on('click', '#delete', function(event) {
        //     event.preventDefault();
        //     $('.aplay_code').load('/xx88/allowedip/delete', function() {
        //         adjustElementSize();
        //         localStorage.setItem('lastPage', '/xx88/allowedip/delete');
        //     });
        // })
        ...
        $(document).on('click', '#delete-allowedip', function(event) {
            ...
            var url =
                "/xx88/allowedip/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
        ...
        $(document).off('click', '#view').on('click', '#view', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/xx88/allowedip/view/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/xx88/allowedip/view/' + id);
            });
        });
        ...
        $(document).off('click', '#edit').on('click', '#edit', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/xx88/allowedip/edit/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/xx88/allowedip/edit/' + id);
            });
        });
