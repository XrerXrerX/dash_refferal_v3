...
<div class="sec_table">
    ...
    <div class="group_button_ns">
        ...
        <div class="ns_right">
            <a href="#" id="update-syaratketentuan">
                <div class="sec_edit">
            ...
            <a href="#" id="delete-syaratketentuan">
        ...
        <tbody>
            ...
            @foreach ($data as $index => $d)
                <tr>
                    ...
                    <td><span class="name">{{ $d->type_aturan }}</span></td>
                    <td><span class="name">{{ $d->icon_syarat }}</span></td>
                    <td><span class="name">{{ $d->desk_syarat }}</span></td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#update-syaratketentuan').off('click').click(function(event) {
            ...
            $('.aplay_code').load('/xx88/syaratketentuan/edit/' + parameterString, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/xx88/syaratketentuan/edit/' +
                    parameterString);
            });
        });


        $(document).off('click', '#add-syaratketentuan').on('click', '#add-syaratketentuan', function(event) {
            event.preventDefault();
            $('.aplay_code').load('/xx88/syaratketentuan/add', function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/xx88/syaratketentuan/add');
            });
        });
        // $(document).on('click', '#delete', function(event) {
        //     event.preventDefault();
        //     $('.aplay_code').load('/xx88/syaratketentuan/delete', function() {
        //         adjustElementSize();
        //         localStorage.setItem('lastPage', '/xx88/syaratketentuan/delete');
        //     });
        // })



        $(document).on('click', '#delete-syaratketentuan', function(event) {
            event.preventDefault();
            ...
            var url =
                "/xx88/syaratketentuan/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
        ...
        $(document).off('click', '#view').on('click', '#view', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/xx88/syaratketentuan/view/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/xx88/syaratketentuan/view/' + id);
            });
        });
        ...
        $(document).off('click', '#edit').on('click', '#edit', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/xx88/syaratketentuan/edit/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/xx88/syaratketentuan/edit/' + id);
            });
        });
