...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#update-syaratketentuan').off('click').click(function(event) {
            ...
            $('.aplay_code').load('/syaratketentuan/edit/' + parameterString, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/syaratketentuan/edit/' +
                    parameterString);
            });
        });
        ...
        $(document).off('click', '#add-syaratketentuan').on('click', '#add-syaratketentuan', function(event) {
            event.preventDefault();
            $('.aplay_code').load('/syaratketentuan/add', function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/syaratketentuan/add');
            });
        });
        // $(document).on('click', '#delete', function(event) {
        //     event.preventDefault();
        //     $('.aplay_code').load('/syaratketentuan/delete', function() {
        //         adjustElementSize();
        //         localStorage.setItem('lastPage', '/syaratketentuan/delete');
        //     });
        // })
        ...
        $(document).on('click', '#delete-syaratketentuan', function(event) {
            ...
            var url =
                "/syaratketentuan/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
        ...
        $(document).off('click', '#view').on('click', '#view', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/syaratketentuan/view/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/syaratketentuan/view/' + id);
            });
        });
        ...
        $(document).off('click', '#edit').on('click', '#edit', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/syaratketentuan/edit/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/syaratketentuan/edit/' + id);
            });
        });
