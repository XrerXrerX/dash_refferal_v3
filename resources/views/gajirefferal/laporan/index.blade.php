        ...
        <tbody>
            ...
            @foreach ($data as $index => $d)
                <tr>
                    ...
                    <td><span class="name">Rp. {{ $d->gaji_refferal }}</span></td>
                    <td><span class="name">Rp. {{ $d->total_potongan }}</span></td>
                    <td><span class="name">Rp. {{ $d->total_casbon }}</span></td>
                    <td><span
                            class="name {{ $d->gaji_refferal - $d->total_potongan - $d->total_casbon < 0 ? 'red-text' : '' }}">Rp.
                            {{ $d->gaji_refferal - $d->total_potongan - $d->total_casbon }}
                        </span>
                    </td>
