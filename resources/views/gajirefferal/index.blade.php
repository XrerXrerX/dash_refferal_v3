...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#update-gajirefferal').off('click').click(function(event) {
            ...
            $('.aplay_code').load('/gajirefferal/edit/' + parameterString, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/gajirefferal/edit/' +
                    parameterString);
            });
        });
        ...
        $(document).off('click', '#add-gajirefferal').on('click', '#add-gajirefferal', function(event) {
            event.preventDefault();
            $('.aplay_code').load('/gajirefferal/add', function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/gajirefferal/add');
            });
        });
        // $(document).on('click', '#delete', function(event) {
        //     event.preventDefault();
        //     $('.aplay_code').load('/gajirefferal/delete', function() {
        //         adjustElementSize();
        //         localStorage.setItem('lastPage', '/gajirefferal/delete');
        //     });
        // })
        ...
        $(document).on('click', '#delete-gajirefferal', function(event) {
            ...
            var url =
                "/gajirefferal/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
        ...
        $(document).off('click', '#view').on('click', '#view', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/gajirefferal/view/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/gajirefferal/view/' + id);
            });
        });
        ...
        $(document).off('click', '#edit').on('click', '#edit', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/gajirefferal/edit/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/gajirefferal/edit/' + id);
            });
        });
