        ...
        <tbody>
            ...
            @foreach ($data as $index => $d)
                <tr>
                    ...
                    <td><span class="name">{{ $d->member_aktif }}</span></td>
                    <td><span class="name">Rp
                            {{ $moneyFormat = number_format((int) $d->gaji_bulan, 0, ',', '.') }}</span>
                    </td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#update-gajirefferal').off('click').click(function(event) {
            ...
            $('.aplay_code').load('/xx88/gajirefferal/edit/' + parameterString, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/xx88/gajirefferal/edit/' +
                    parameterString);
            });
        });


        $(document).off('click', '#add-gajirefferal').on('click', '#add-gajirefferal', function(event) {
            event.preventDefault();
            $('.aplay_code').load('/xx88/gajirefferal/add', function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/xx88/gajirefferal/add');
            });
        });
        // $(document).on('click', '#delete', function(event) {
        //     event.preventDefault();
        //     $('.aplay_code').load('/xx88/gajirefferal/delete', function() {
        //         adjustElementSize();
        //         localStorage.setItem('lastPage', '/xx88/gajirefferal/delete');
        //     });
        // })



        $(document).on('click', '#delete-gajirefferal', function(event) {
            event.preventDefault();
            ...
            var url =
                "/xx88/gajirefferal/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
        ...
        $(document).off('click', '#view').on('click', '#view', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/xx88/gajirefferal/view/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/xx88/gajirefferal/view/' + id);
            });
        });
        ...
        $(document).off('click', '#edit').on('click', '#edit', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/xx88/gajirefferal/edit/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/xx88/gajirefferal/edit/' + id);
            });
        });
