...
<div class="sec_list_sidemenu">
    ...
    <div class="nav_group">
        <span class="title_Nav">Laporan</span>
        <div class="list_sidejsx">
            <div class="data_sidejsx">
                <a href="#" id="Laporan">
                    ...
                    <span class="nav_title1">Laporan</span>
                </a>
            </div>
            <div class="data_sidejsx">
                <a href="#">
                    ...
                    <span class="nav_title1">Input Data</span>
            ...
            <div class="sub_data_sidejsx">
                <a href="#" id="Downline">
                    <div class="list_subdata active">
                        ...
                        <span class="sub_title1">Downline</span>
                    </div>
                </a>
                <a href="#" id="Newmember">
                    <div class="list_subdata">
                        <div class="dotsub"></div>
                        <span class="sub_title1">New Member</span>
                    </div>
                </a>
            </div>
            <div class="data_sidejsx">
                <a href="#" id="Tabelgaji">
                    ...
                    <span class="nav_title1">Table Gaji</span>
                </a>
            </div>
            <div class="data_sidejsx">
                <a href="#" id="Datakasbon">
                    ...
                    <span class="nav_title1">Data Kasbon</span>
                </a>
            </div>
            <div class="data_sidejsx">
                <a href="#" id="Datamitra">
                    ...
                    <span class="nav_title1">Data Mitra</span>
                </a>
            </div>
        ...
        <div class="list_sidejsx">
            <div class="data_sidejsx">
                <a href="#" id="Pencarirefferal">
                    ...
                    <span class="nav_title1">List Userid Event</span>
                </a>
            </div>
            <div class="data_sidejsx">
            ...
            <div class="data_sidejsx">
                <a href="#" id="Syaratketentuan">
                    ...
                    <span class="nav_title1">Syarat & Ketentuan</span>
                </a>
            </div>
            <div class="data_sidejsx">
                <a href="#" id="Datapopup">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-rocket"
                        width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                        fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                        <path
                    ...
                    <span class="nav_title1">Data Popup</span>
                </a>
            </div>
            <div class="data_sidejsx">
                <a href="#" id="Adminl21">
                    ...
                    <span class="nav_title1">Admin</span>
                </a>
            </div>
