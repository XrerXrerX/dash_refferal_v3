        ...
        <tbody>
            ...
            @foreach ($data as $index => $d)
                <tr>
                    ...
                    <td><span class="name">{{ $d->mitra_baru == '1' ? 'Mitra Baru' : 'Mitra Lama' }}</span></td>
                    <td><span class="name">{{ $d->namapage }}</span></td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#update-userrefferal').off('click').click(function(event) {
        ...
        $(document).on('click', '#delete-userrefferal', function(event) {
            event.preventDefault();
