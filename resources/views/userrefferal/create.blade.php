    ...
    <form action="" method="POST" enctype="multipart/form-data" id="form">
        ...
        <div class="sec_form">
            ...
            <div class="list_form">
                ...
                <input type="text" id="userid_refferal" name="userid_refferal" placeholder="Masukkan Userid Refferal"
                    required>
            </div>
            <div class="list_form">
            ...
            <div class="list_form">
                ...
                <div class="pilihan_gambar">
                    ...
                    <button type="button" class="img_gallery triggermodal" data-target="nilai-2">Pilih Gallery</button>
                </div>
            </div>
            <div class="list_form">
                <span class="sec_label">Color Page</span>
                <select id="color_page" name="color_page">
                    <option value="prfcto1">prfcto1</option>
                    <option value="prfcto2">prfcto2</option>
                    <option value="prfcto3">prfcto3</option>
                    <option value="prfcto4">prfcto4</option>
                </select>
            </div>
            <div class="list_form">
            ...
            <div class="list_form">
                ...
                <select id="btn_daftar_color" name="btn_daftar_color">
                    <option value="btncto1">btncto1</option>
                    <option value="btncto2">btncto2</option>
                    <option value="btncto3">btncto3</option>
                    <option value="btncto4">btncto4</option>
                    <option value="btncto5">btncto5</option>
                </select>
            </div>
            <div class="list_form">
                <span class="sec_label">Warna Button Login</span>
