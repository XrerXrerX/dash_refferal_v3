...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#update-user').off('click').click(function(event) {
            ...
            $('.aplay_code').load('/xx88/user/edit/' + parameterString, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/xx88/user/edit/' +
                    parameterString);
            });
        });
        ...
        $(document).off('click', '#add-user').on('click', '#add-user', function(event) {
            event.preventDefault();
            $('.aplay_code').load('/xx88/user/add', function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/xx88/user/add');
            });
        });
        // $(document).on('click', '#delete', function(event) {
        //     event.preventDefault();
        //     $('.aplay_code').load('/xx88/user/delete', function() {
        //         adjustElementSize();
        //         localStorage.setItem('lastPage', '/xx88/user/delete');
        //     });
        // })
        ...
        $(document).on('click', '#delete-user', function(event) {
            ...
            var url =
                "/xx88/user/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
        ...
        $(document).off('click', '#view').on('click', '#view', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/xx88/user/view/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/xx88/user/view/' + id);
            });
        });
        ...
        $(document).off('click', '#edit').on('click', '#edit', function(event) {
            ...
            var id = $(this).data('id');
            $('.aplay_code').empty();
            $('.aplay_code').load('/xx88/user/edit/' + id, function() {
                adjustElementSize();
                localStorage.setItem('lastPage', '/xx88/user/edit/' + id);
            });
        });
