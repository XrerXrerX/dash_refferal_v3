...
$(document).ready(function () {
    ...
    canvas.toBlob(function (croppedBlob) {
        ...
        success: function (response) {
            ...
            $("img").attr("src", "images/user_refferal_img/" + uniqueFilename);
            location.reload();
            } else {
